...
- [3. 프로젝트 개요](#3-프로젝트-개요)
  ...
  - [3.4. 기대효과](#-기대효과)
  - [3.5. 대상 사용자](#-대상-사용자)
  - [3.6. 프로젝트 폴더 구조](#-프로젝트-폴더-구조)
  - [3.7. 모듈 및 함수 별 기능](#모듈-및-함수-별-기능)
  - [3.8. LangGraph Flow](#-langgraph-flow)
  - [3.9. 시스템 아키텍쳐](#-시스템-아키텍쳐)
  - [3.10. 전체 파이프라인](#-전체-파이프라인)
  - [3.11. 단계별 입·출력](#-단계별-입출력)
  - [3.12. 프롬프트](#프롬프트)
    - [System Prompt](#system-prompt)
    - [Answer Prompt](#answer-prompt)
    - [프롬프트 의도](#프롬프트-의도)
  - [3.13 데이터 전처리](#데이터-전처리)
  - [3.14 환경설정](#환경설정)
    
[4. 기술스택](#-4.-기술스택) 

[5. 수행결과](#-5.-수행결과)
  - [5.1. 홈 화면(Overview)](#-0-홈-화면overview)
  - [5.2. 답변 섹션(개요 + RAG 코드 샘플)](#-1-답변-섹션개요--rag-코드-샘플)
  - [5.3. 근거 스니펫(세부 확인 패널)](#-2-근거-스니펫세부-확인-패널)
  - [5.4. 질의/옵션 입력 영역(실행 패널)](#-3-질의옵션-입력-영역실행-패널)
  - [5.5. 최종 답변 + 근거 요약(결과 패널)](#-4-최종-답변--근거-요약결과-패널)
  - [5.6. 답변 방식 비교](#-5-답변-방식-비교)
